<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kayit.aspx.cs" Inherits="hastaneprojenyn.hospitaltemplatenyn.rubic.kayit" %>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-md-7">
                    <div class="header-content">
                        ...
                        <h4 class="header-subtitle">Kayıt olmak için bilgilerinizi giriniz</h4>
                    </div>  
                </div>
                <div class="col-md-5 d-none d-md-block">
                    <form class="header-form">
                        ...
                        <div class="footer"> 
                            <asp:Button ID="Button1" runat="server" class="btn btn-primary btn-block" OnClick="Button1_Click"  Text="Kayıt Ol" />
                        </div>
                    </form> 
                </div>
            </div>  
